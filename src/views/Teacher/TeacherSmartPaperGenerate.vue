...
const toggleChapter = (chapterId) => {
  const index = formData.value.chapterIds.indexOf(chapterId)
  if (index > -1) {
    formData.value.chapterIds.splice(index, 1)
  } else {
    formData.value.chapterIds.push(chapterId)
  }
}
